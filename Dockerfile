ARG CENTOS_VERSION
FROM --platform=linux/amd64 centos:$CENTOS_VERSION
EXPOSE 8080
ENV XPRA_UID 5001
RUN mkdir -p /tmp/.X11-unix && \
    ...
    dnf -y update && \
    dnf -y --nodocs install xpra xpra-html5 xterm x264-xpra ffmpeg-xpra python3-devel python3-uinput lz4 python3-lz4 && \
